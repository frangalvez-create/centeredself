-- Revert Database to "Added delete functionality to Fav list" State
-- This script will clean up the database to match the git commit 31690a3
...
-- Verify cleanup
SELECT 'Database reverted to "Added delete functionality to Fav list" state' as status;
